...
vec4 pointLight()
{
  ...
  vec4 diffuse=vec4(0.005,0.005,0.02,1.0);
  ...
  // Compute distance between surface and light position
    ...
    ndothv = max(dot(N, halfV), 0.65);
    specular+=(material.specular*7.5)*light.specular*pow(ndothv, (material.shininess*8))* attenuation;
  }
