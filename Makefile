...
SOURCES       = src/main.cpp \
		src/MainWindow.cpp \
		src/NGLScene.cpp moc/moc_MainWindow.cpp \
...
DIST          = CEB.pro include/MainWindow.h \
		include/NGLScene.h src/main.cpp \
		src/MainWindow.cpp \
		src/NGLScene.cpp
QMAKE_TARGET  = CEB
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/MainWindow.h include/NGLScene.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/MainWindow.cpp src/NGLScene.cpp $(DISTDIR)/
