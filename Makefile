...
INCPATH       = -I. -Iinclude -I/home/i7685565/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -Imoc -I/opt/qt/5.5/gcc_64/mkspecs/linux-g++
...
DISTDIR = /home/i7685565/0Features-0BugsCVA3/obj/SimpleNGL1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) /home/i7685565/0Features-0BugsCVA3/lib/libqscintilla2.a -L/usr/local/lib -L/home/i7685565/NGL/lib -l NGL -ltiff -L/opt/qt/5.5/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/json.cpp \
		src/main.cpp \
		src/NGLScene.cpp \
		src/project.cpp moc/moc_NGLScene.cpp
OBJECTS       = obj/json.o \
		obj/main.o \
		obj/NGLScene.o \
		obj/project.o \
...
DIST          = CEB.pro include/json.h \
		include/NGLScene.h \
		include/project.h src/json.cpp \
		src/main.cpp \
		src/NGLScene.cpp \
		src/project.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/json.h include/NGLScene.h include/project.h $(DISTDIR)/
	$(COPY_FILE) --parents src/json.cpp src/main.cpp src/NGLScene.cpp src/project.cpp $(DISTDIR)/
...
moc/moc_NGLScene.cpp: /home/i7685565/NGL/include/ngl/Camera.h \
