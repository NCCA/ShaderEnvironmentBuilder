...
The new \doxyref{Project}{p.}{class_project} Wizard that is used to create a new project.  
...
The new \doxyref{Project}{p.}{class_project} Wizard that is used to create a new project. \begin{DoxyAuthor}{Author}
Jonathan Flynn 
\end{DoxyAuthor}
...
Definition in file {\bf New\-Project\-Wizard.\-h}.
