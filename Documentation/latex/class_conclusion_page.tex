...
Definition at line 406 of file New\-Project\-Wizard.\-cpp.
...
\begin{DoxyCode}
407   : QWizardPage(parent)
408 \{
409   setTitle(tr(\textcolor{stringliteral}{"Conclusion"}));
410 
411   m_label = \textcolor{keyword}{new} QLabel;
412   m_label->setWordWrap(\textcolor{keyword}{true});
413 
414   QVBoxLayout *layout = \textcolor{keyword}{new} QVBoxLayout;
415   layout->addWidget(m_label);
...
Definition at line 420 of file New\-Project\-Wizard.\-cpp.
...
\begin{DoxyCode}
421 \{
422   QString finishText = wizard()->buttonText(QWizard::FinishButton);
423   finishText.remove(\textcolor{charliteral}{'&'});
424   m_label->setText(tr(\textcolor{stringliteral}{"Click %1 to generate the project."})
425                    .arg(finishText));
426 \}
\end{DoxyCode}
